module.exports = {
  apps: [{
    ...
    watch: false, // IMPORTANT: Keep false for production; consider Nodemon or similar for dev
    ...
    error_file: "/home/ubuntu/logs/app-err.log", // Path for PM2 error logs for this app
    out_file: "/home/ubuntu/logs/app-out.log", // Path for PM2 standard output logs for this app
    ...
    // It's often better to manage development settings locally (e.g., .env file)
    // and not rely on PM2 for 'development' mode on a server unless it's a dev server.
    // For simplicity in your CircleCI deployment, we focus on env_production.
    // env: {  
    ...
    env_production: {
      ...
      TYPEORM_HOST: "udapeople-db2.cdm12qoa5cy1.eu-north-1.rds.amazonaws.com",
      TYPEORM_PORT: 5432, // Ensure your app expects this as a number if TypeORM needs it. String is usually fine for env vars.
      ...
      TYPEORM_SYNCHRONIZE: "false", // CORRECT for production
      TYPEORM_ENTITIES: "dist/modules/domain/**/*.entity.js", // String is fine
      TYPEORM_MIGRATIONS: "dist/migrations/*.js", // String is fine
      // TYPEORM_MIGRATIONS_DIR: "dist/migrations", // Typically handled by TypeORM CLI config, not always needed as env var
    ...
    // Note: NO Webpack devServer, resolve.alias, or Plugins sections here.
  }]
};
